...
from src.plots import plot_energy_bands, plot_closed_loop, plot_berry_phases, plot_h_ellipse
...
fig1, ax1 = plot_energy_bands(k_values, EiVa, title="SSH bands (midbond)")
plt.show()
